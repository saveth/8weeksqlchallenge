...
select sales.customer_id  
     , sum(case 
     	when n.new_member is NULL  and product_name = 'sushi' then menu.price * 10 * 2
           when n.new_member is NULL  and product_name <> 'sushi' then menu.price * 10 
        else menu.price * 10 * 2 
     	end) as promotion 
from dannys_diner.sales
...
) n on sales.customer_id = n.customer_id and 
sales.order_date = n.order_date
